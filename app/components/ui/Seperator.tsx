...
function Separator({ text }: Props) {
  return (
    <div className="py-20 mt-12 flex items-center justify-center">
      ...
      {/* LEFT LINE */}
      <div className="relative w-full max-w-[250px] h-[1px] bg-gradient-to-r from-transparent via-purple-500/40 to-blue-500/60">
      ...
      {/* TEXT BADGE */}
      <div className="mx-6 px-5 py-2 rounded-full 
      ...
      {/* RIGHT LINE */}
      <div className="relative w-full max-w-[250px] h-[1px] bg-gradient-to-l from-transparent via-purple-500/40 to-blue-500/60">
